	...
	<body>
		<div>
			<form action="seekerProfile.jsp" name="seekerProfileform" method="POST">
	    		...
	    		<div id="container">
				<ul id="griglia">
				<li><button class="cv_btn" style="width:200px;height:160px;background-color:lightblue">Curriculum Vitae</button></li>
				<li><button class="id_btn" style="width:200px;height:160px;background-color:lightblue"><br>Personal Info</button></li>
				<li><button class="offers_btn" style="width:200px;height:160px;background-color:lightblue">Applications</button></li>
				<li><button class="favourites_btn" style="width:200px;height:160px;background-color:lightblue">Favourites</button></li>
				</ul>
				</div>
				</div>
	    	</form>
